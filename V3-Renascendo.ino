...
bool lerVerde1() {
  ...
  if (cc1 <= valorCnoBranco || cc2 <= valorCnoBranco) {
    bool verdeDireita = (g1 > r1 && g1 > b1 && g1 - r1 > diferencaDasCores && g1 - b1 > diferencaDasCores && 
                        cc1 >= minCVerde && cc1 <= maxCVerde && luu1 >= minLuxVerde && luu1 <= maxLuxverde);            
    bool verdeEsquerda =(g2 > r2 && g2 > b2 && g2 - r2 > diferencaDasCores && g2 - b2 > diferencaDasCores && 
    ...
    Serial.print("g1 - b1 > diferencaDasCores: "); Serial.println(g1 - b1 > diferencaDasCores);
    ...
    Serial.print("g2 - b2 > diferencaDasCores: "); Serial.println(g2 - b2 > diferencaDasCores);
    Serial.print("cc1 >= minCVerde && cc1 <= maxCVerde: "); Serial.println(cc1 >= minCVerde && cc1 <= maxCVerde);
    Serial.print("cc2 >= minCVerde && cc2 <= maxCVerde: "); Serial.println(cc2 >= minCVerde && cc2 <= maxCVerde);
    Serial.print("luu1 >= minLuxVerde && luu1 <= maxLuxverde: "); Serial.println(luu1 >= minLuxVerde && luu1 <= maxLuxverde);
    Serial.print("luu2 >= minLuxVerde && luu2 <= maxLuxverde: "); Serial.println(luu2 >= minLuxVerde && luu2 <= maxLuxverde);
...
void giroVerde() {
  ...
  // Teste para verde
  if (cc1 <= valorCnoBranco || cc2 <= valorCnoBranco) {
    bool verdeDireita = (g1 > r1 && g1 > b1 && g1 - r1 > diferencaDasCores && g1 - b1 > diferencaDasCores && cc1 >= minCVerde && cc1 <= maxCVerde && luu1 >= minLuxVerde && luu1 <= maxLuxverde);
    bool verdeEsquerda = (g2 > r2 && g2 > b2 && g2 - r2 > diferencaDasCores && g2 - b2 > diferencaDasCores && cc2 >= minCVerde && cc2 <= maxCVerde && luu2 >= minLuxVerde && luu2 <= maxLuxverde);
    bool verdeAmbos = (abs(cc1 - cc2) < subtracaoSensoresCor) && verdeDireita && verdeEsquerda;
